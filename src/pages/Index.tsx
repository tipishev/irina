...
const ceramicsCourse = {
  ru: {
    ...
    description: "Приглашаем детей на увлекательный летний курс по созданию народной глиняной игрушки! За 5 дней ребята создадут пять уникальных игрушек в традиционных техниках: дымковская, абашаевская и филимоновская.",
    includes: "🔹 Все материалы, работа с глиной и обжиг — включены",
    note: "⚠️ Готовые изделия можно будет забрать осенью (после сушки и обжига)",
    pricing: {
      title: "💰 Стоимость:",
      full: "– 1700 kr за весь курс",
      single: "– Drop-in (разовое занятие): 350 kr"
    },
    registration: "📞 Запись только по предоплате\nРегистрация: 073-517 33 30",
    schedule: [
      "* 11 августа Филимоновская игрушка ( котики, петушки, лисы)",
      "* ⁠12 августа Дымковская игрушка (Барыня)",
      "* ⁠13 августа Дымковская ( козлики и барашки)",
      "* ⁠14 августа Дымковская ( гуси , утки , жар птицы и индюки)",
      "* ⁠15 августа Абашаевская игрушка ( гусары на конях)"
    ]
  },
  en: {
    title: "🏺 Ceramics Course \"Folk Toy\"",
    dates: "📅 August 11–15",
    time: "🕙 Time: 10:00 AM to 1:00 PM",
    address: "📍 Address: Stopvägen 38",
    age: "👧 Age: from 7 years",
    description: "We invite children to an exciting summer course on creating folk clay toys! In 5 days, children will create five unique toys in traditional techniques: Dymkovo, Abashev and Filimonov.",
    includes: "🔹 All materials, clay work and firing — included",
    note: "⚠️ Finished products can be picked up in autumn (after drying and firing)",
    pricing: {
      title: "💰 Cost:",
      full: "– 1700 kr for the entire course",
      single: "– Drop-in (single lesson): 350 kr"
    },
    registration: "📞 Registration only with prepayment\nRegistration: 073-517 33 30",
    schedule: [
      "* August 11 Filimonov toy (cats, roosters, foxes)",
      "* August 12 Dymkovo toy (Lady)",
      "* August 13 Dymkovo (goats and rams)",
      "* August 14 Dymkovo (geese, ducks, firebirds and turkeys)",
      "* August 15 Abashev toy (hussars on horses)"
    ]
  },
  sv: {
    title: "🏺 Keramikkurs \"Folkspegleksak\"",
    dates: "📅 11–15 augusti",
    time: "🕙 Tid: 10:00 till 13:00",
    address: "📍 Adress: Stopvägen 38",
    age: "👧 Ålder: från 7 år",
    description: "Vi bjuder in barn till en spännande sommerkurs i att skapa folk lerleksaker! På 5 dagar kommer barnen att skapa fem unika leksaker i traditionella tekniker: Dymkovo, Abashev och Filimonov.",
    includes: "🔹 Alla material, lerarbete och bränning — ingår",
    note: "⚠️ Färdiga produkter kan hämtas på hösten (efter torkning och bränning)",
    pricing: {
      title: "💰 Kostnad:",
      full: "– 1700 kr för hela kursen",
      single: "– Drop-in (enstaka lektion): 350 kr"
    },
    registration: "📞 Anmälan endast med förskottsbetalning\nRegistrering: 073-517 33 30",
    schedule: [
      "* 11 augusti Filimonov leksak (katter, tuppar, rävar)",
      "* 12 augusti Dymkovo leksak (Dam)",
      "* 13 augusti Dymkovo (getter och baggar)",
      "* 14 augusti Dymkovo (gäss, änder, eldfjäder och kalkoner)",
      "* 15 augusti Abashev leksak (husarer på hästar)"
    ]
  }
};
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="w-full md:w-1/2">
              <img
                src="/lovable-uploads/659149af-bd2e-44f2-b670-38d18051d56a.png"
                alt="Folk Toy Ceramics Course"
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-secondary font-medium">{ceramicsCourse[currentLang].dates}</p>
                <p className="text-secondary/80">{ceramicsCourse[currentLang].time}</p>
                <p className="text-secondary/80">{ceramicsCourse[currentLang].address}</p>
              ...
              <div className="space-y-2">
                <p className="text-secondary/80">{ceramicsCourse[currentLang].includes}</p>
                <p className="text-orange-600 font-medium">{ceramicsCourse[currentLang].note}</p>
              </div>

              {/* Pricing */}
              <div className="bg-green-50 p-4 rounded-lg">
                <h4 className="font-semibold text-secondary mb-2">
                  {ceramicsCourse[currentLang].pricing.title}
                </h4>
                <div className="space-y-1 text-sm text-secondary/80">
                  <p>{ceramicsCourse[currentLang].pricing.full}</p>
                  <p>{ceramicsCourse[currentLang].pricing.single}</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold text-secondary mb-3">Программа курса:</h4>
                <div className="space-y-2">
                  {ceramicsCourse[currentLang].schedule.map((item, index) => (
                    <p key={index} className="text-sm text-secondary/80">{item}</p>
                  ))}
                </div>
              </div>
            </div>
